...
VALUES (
        ...
        NULL,
        -- Onboarding completed at (NULL if not completed yet)
        'USER'
    );
...
VALUES (
        ...
        'Female',
        -- Gender
        'Passionate about technology and exploring new places.',
        -- Biography
        ST_GeomFromText('POINT(34.052235 -118.243683)'),
        -- Location (latitude and longitude of Los Angeles, CA)
        NULL,
        -- URL for profile picture
        50,
        -- Distance preference (in km)
        ...
        -- Updated timestamp
        NULL,
        -- Deleted timestamp (NULL means not deleted)
        1,
        -- Show birthday (1 = true,0 = false)
